...
def construct_refinement_prompt(prompt: str, unit_test: str, sample: str, base_detail: bool) -> str:
    if base_detail:
...
### feedback
The code above is correct. You can choose to optimize it or return the function itself. Watch out for function/variable names, exception handling, and other errors.
